      ...
      <div className='gallery'>
        {bicycles.map((bicycle) => (
          <div className='gallerygrid' key={bicycle.id}>
            <img onClick={() => {
              console.log("ID de la bicicleta seleccionada:", bicycle.id); // Agregar console.log aquí
              navigate(`/card/${bicycle.id}`);
            }} className="bicyclesimg" src={bicycle.image} alt={bicycle.model} />
            <p>{bicycle.model}</p>
